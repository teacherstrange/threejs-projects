...
//     this.startingScreen.loadingLabel.geometry = new THREE.PlaneBufferGeometry(
//       2.5,
//       2.5 / 4,
//     );
...
//         TweenLite.to(
//           this.startingScreen.area.floorBorder.material.uniforms.uAlpha,
//           0.3,
//           { value: 0.3 },
//         );
